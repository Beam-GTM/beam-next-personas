...
| **Steven Pinker** | Writing | "The Sense of Style", Harvard linguist | Clear writing, editing, removing jargon |
...
- Andy Grove (OKRs, management)
- Keith Rabois (ops, scaling, barrels)
- Frank Slootman (intensity, turnarounds)
- Eliyahu Goldratt (bottlenecks)
- W. Edwards Deming (quality, processes)
...
- Keith Rabois (cut complexity)
- Frank Slootman (narrow focus)

### People & Culture
- Claire Hughes Johnson (hiring, org design)
- Kim Scott (feedback, Radical Candor)
- Ray Dalio (principles, culture)
- Esther Perel (conversations, dynamics)
...
- Marty Cagan (empowered teams, discovery)
- Shreyas Doshi (prioritization, LNO)
- Lenny Rachitsky (growth, metrics)
...
- Kent Beck (TDD, XP, craftsmanship)
- Will Larson (eng leadership, Staff+)
- Camille Fournier (eng management)
- Marc Andreessen (platform thinking)

### Innovation & First Principles
- Elon Musk (first principles, moonshots)
...
See `BACKLOG.md` for personas ready to be created on-demand.
